...
import { fetchClaimablePositions, redeemPositions } from '@/lib/polymarket/redeem';
...
export async function POST(req: NextRequest) {
  ...
  const { profileId, conditionId, negRisk, yesTokenId, noTokenId } = body;
  ...
  const result = await redeemPositions(profile, conditionId, negRisk ?? false, yesTokenId, noTokenId);
