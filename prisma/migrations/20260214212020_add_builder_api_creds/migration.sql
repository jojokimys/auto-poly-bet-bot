...
INSERT INTO "new_BotProfile" ("apiKey", "apiPassphrase", "apiSecret", "createdAt", "funderAddress", "id", "isActive", "name", "privateKey", "signatureType", "strategy", "updatedAt") SELECT "apiKey", "apiPassphrase", "apiSecret", "createdAt", "funderAddress", "id", "isActive", "name", "privateKey", "signatureType", "strategy", "updatedAt" FROM "BotProfile";
